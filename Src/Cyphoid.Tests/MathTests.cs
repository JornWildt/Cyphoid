...
namespace Cyphoid.Tests
{
  ...
  internal class MathTests : TestHelper
  {
    ...
    public void OneTimeSetUp()
    {
      ...
      // Orders
      Graph.AddNode("Order1", "_order");
      Graph.AddNode("Order2", "_order");
      Graph.AddNode("Order3", "_order");
      Graph.AddNode("Order4", "_order");
      Graph.AddNode("Order5", "_order");
      Graph.AddNode("Order6", "_order");
    ...
    [TestCase("MATCH (o:_order) RETURN COUNT(*) AS orderCount")]
    public async Task ItCanExecuteBasicQuery(string input)
    {
      // Act
